...
class Table extends Component {
    ...
    <div className="col-lg-10 offset-lg-1 col-md-10 col-sm-12 col-xs-12">
        ...
        <tbody>
            ...
            <td>
                <span className="fas fa-minus-circle" onClick={() => this.props.deleteTodo(todo.id)} style={{ color: "white", fontSize: "12pt", marginRight: "12px"}}>Delete</span>
                <span className="fas fa-check-circle" onClick={() => this.props.toggleTodo(todo.id)} style={{ color: "white", fontSize: "12pt" }}>Completed</span>
            </td>
            </tr>
            ))}
        </tbody>
